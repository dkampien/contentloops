...
*   [Cancel-After](#predictions.create-headers-cancel-after)string
...
### [](#models.list-query-parameters)Query Parameters

*   [sort\_by](#models.list-query-parameters-sortby)string
    
    Field to sort models by. Defaults to `latest_version_created_at`.
    
*   [sort\_direction](#models.list-query-parameters-sortdirection)string
...
*   [Cancel-After](#models.predictions.create-headers-cancel-after)string
...
*   [Cancel-After](#deployments.predictions.create-headers-cancel-after)string
