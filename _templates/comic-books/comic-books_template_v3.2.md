# Comic Book Bible Stories - Template v3.2
...
**Note for Seedream 4:** This model prefers "concise and precise" over verbose, ornate descriptions. Lean toward Low-Medium detail.
...
**Assembly rules:**
- **Write in natural flowing sentences** - "A young man sits against a wall in a dim prison cell"
- **Not attribute lists** - NOT "Young man, wall, prison cell, sitting"
...
**9. Manage loaded keywords carefully** ⭐ **CRITICAL for Seedream 4**
- Keywords like "Egyptian", "Hebrew", "ancient" trigger strong visual associations
- **Use these keywords ONCE** (typically Panel 1 to establish context)
- **In later panels, use neutral terms:** "the man" (not "Hebrew man"), "the prison cell" (not "ancient Egyptian prison cell")
- **Why:** Repetition amplifies visual influence, causing style bleeding (unexpected clothing, beards, jewelry, cultural elements)
- Full character descriptions must still be repeated, but remove loaded cultural/setting keywords after Panel 1
- **Examples:** "Egyptian" repeated → Panel gets Egyptian headbands/jewelry. "Hebrew" repeated → Character grows beard.
...
### Part 7: Example (Seedream 4 Optimized)

**Story:** Joseph Dreams - PAGE 1
...
**Key elements:**
- "Hebrew" and "ancient" used only in Panel 1 (establishes context)
- Panel 3 uses "young man" (removed "Hebrew") to avoid style bleeding
- Full character descriptions repeated in Panel 3 for consistency
- Natural flowing sentences, not attribute lists
- Concise but complete detail
...
**v3.2 Changes:** Added Seedream 4-specific guidance (loaded keyword management, natural language assembly)
