...
**Note:** Default to full story creation (Steps 1-4 all at once) for Main Series. Use page-by-page approach for experimental/complex stories. **(TBD - pending workflow testing)**
...
2. Character definitions - list each recurring character with full appearance description (10-15 words: hair, face, clothing)
3. Panel-by-panel moment breakdown - what specific action/dialogue happens in each panel
...
Character Definitions (for this page):
- Goliath: Massive armored warrior with bronze helmet and plume, holding large spear
- David: Young shepherd boy in simple tunic, carrying basket
...
Character Definitions (for this page):
- David: Young shepherd boy in simple tunic
- Saul: King in royal robes with crown
...
Generate prompts directly from Step 2 panel moments and character definitions using the block-based formula system.

**Input:** Step 2 provides panel moments (what happens) and character definitions (appearances). Your job: add visual/technical details and organize into blocks.

**Approach:** Think like a director of photography - how would you visually capture each moment? Choose shot composition, positioning, lighting, then fill blocks.
...
- Fill block values from Step 2 moments and character definitions (library provides structure, you provide values)
- Use character definitions from Step 2 exactly as written for consistency
...
**Step 2 input (Panel 1):**
"Panel 1: Two armies face each other across valley, tense standoff atmosphere"

**Character definitions from Step 2:** (none for this panel - just armies)
